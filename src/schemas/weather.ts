...
// Health interface - deprecated in latest endpoint, moved to dedicated health endpoint
...
// Latest weather response - health field is deprecated
export interface WeatherXMLatestResponse {
	observation: Observation
	health?: Health // Optional since it's deprecated
	location: Location
}

// Dedicated health endpoint response
export interface WeatherXMHealthResponse {
	health: Health
}
